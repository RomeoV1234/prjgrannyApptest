...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener()
        {
            ...
            Login().AddOldUsers()
            var Shouldbeallowedin:Boolean = Login().checkUser(txtName.text.toString(),txtPassword.text.toString())
            ...
            else
            {
                Toast.makeText(this, "Wrong details entered or" +
                        "else I did something wrong #rest if fot homework",Toast.LENGTH_SHORT).show()
            }
        }
    }
}